...
describe("SliderIndicator", () => {
  ...
  it("renders with length=1 (snapshot)", () => {
    const { toJSON } = render(<SliderIndicator length={1} currentIndex={0} />);
    expect(toJSON()).toMatchSnapshot();
  });
});
